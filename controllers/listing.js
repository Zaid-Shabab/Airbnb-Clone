...
module.exports.createListing    = async (req, res) => {
    // 
    let locationQuery = encodeURIComponent(req.body.listing.location);
let response = await fetch(`https://nominatim.openstreetmap.org/search?format=json&q=${locationQuery}`, {
